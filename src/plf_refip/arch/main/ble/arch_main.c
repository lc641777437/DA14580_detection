...
void app_get_scanning(void)
{
    struct gapc_get_info_cmd*cmd =(struct gapc_get_info_cmd *) KE_MSG_ALLOC(GAPC_GET_PEER_NAME, TASK_GAPC, TASK_APP, gapc_get_info_cmd);
    cmd->operation = GAPC_GET_PEER_NAME; // Set GAPM_SCAN_PASSIVE
