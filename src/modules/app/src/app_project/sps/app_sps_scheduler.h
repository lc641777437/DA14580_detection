...
#define RX_CALLBACK_SIZE        (uint8_t)	128
...
extern uint8_t rx_read_pointer[RX_CALLBACK_SIZE];
...
uint8_t app_uart_pull(uint8_t* rddata, uint8_t readamount, uint8_t* state);
void app_uart_push(uint8_t* wrdata, uint8_t writeAmount, uint8_t state);
/**
 ****************************************************************************************
