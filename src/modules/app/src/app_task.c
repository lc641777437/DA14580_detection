...
#endif //(NVDS_SUPPORT)
#define APP_DFLT_ADV_addr        "\x06\x00\x00\xca\xea\x80"
#define APP_DFLT_ADV_addr_LEN    (6)
...
int gapc_peername_ind_handler(ke_msg_id_t const msgid,
                                        struct gapc_peer_name_ind const *param,
